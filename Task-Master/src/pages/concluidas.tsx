    ...
    if (concludedTasks.length === 0) {
        return (
            <Init>
                <div className="flex flex-col items-center justify-center h-[70vh] text-center">
                    ...
                    <p className="text-gray-400 max-w-md"> Nenhuma tarefa concluída ainda. Termine logo uma e ela aparecerá aqui!! </p>                
                </div>
            </Init>
        );
    } else {
        return (
            <Init>
               ...
               { concludedTasks.length > 0 && ( <div className="relative duration-500">
                    <button title="Deletar Todas!" className="fixed right-10 bottom-10 flex items-center bg-blue-800 rounded-full shadow-lg shadow-gray-700 hover:bg-blue-500 cursor-pointer transition-transform hover:scale-110 outline-none"
